...
extension ItemModelQueryWhereSort
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterWhere> anyIsFavorite() {
    return QueryBuilder.apply(this, (query) {
...
extension ItemModelQueryWhere
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterWhereClause> isFavoriteEqualTo(
    bool isFavorite,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterWhereClause> isFavoriteNotEqualTo(
    bool isFavorite,
  ) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
...
extension ItemModelQueryFilter
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterFilterCondition> isFavoriteEqualTo(
    bool value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
...
extension ItemModelQuerySortBy on QueryBuilder<ItemModel, ItemModel, QSortBy> {
  QueryBuilder<ItemModel, ItemModel, QAfterSortBy> sortByIsFavorite() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFavorite', Sort.asc);
    });
  }

  QueryBuilder<ItemModel, ItemModel, QAfterSortBy> sortByIsFavoriteDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ItemModelQuerySortThenBy
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterSortBy> thenByIsFavorite() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFavorite', Sort.asc);
    });
  }

  QueryBuilder<ItemModel, ItemModel, QAfterSortBy> thenByIsFavoriteDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isFavorite', Sort.desc);
    });
  }
...
extension ItemModelQueryWhereDistinct
  ...
  QueryBuilder<ItemModel, ItemModel, QDistinct> distinctByIsFavorite() {
    return QueryBuilder.apply(this, (query) {
...
extension ItemModelQueryProperty
  ...
  QueryBuilder<ItemModel, bool, QQueryOperations> isFavoriteProperty() {
    return QueryBuilder.apply(this, (query) {
